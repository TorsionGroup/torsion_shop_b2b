...
class Message(models.Model):
    ...
    from_user = models.ForeignKey(User, on_delete=models.DO_NOTHING, related_name='messages', verbose_name=_("User"))
    date = models.DateTimeField(_('Date'))
    chat = models.ForeignKey(Chat, on_delete=models.DO_NOTHING, related_name='messages', verbose_name=_("Chat"))
    forward_from = models.ForeignKey(User, on_delete=models.DO_NOTHING, null=True, blank=True,
                                     related_name='forwarded_from', verbose_name=_("Forward from"))
...
class Update(models.Model):
    ...
    message = models.ForeignKey(Message, on_delete=models.DO_NOTHING, null=True, blank=True, verbose_name=_('Message'),
